defmodule Bank.Ach.WebEntry do
  ...
  def parse!(text, line_number, opts) do
    ...
    |> field!(:dfi_account_number, :R, :alphanumeric, 17)
    |> field!(:amount, :M, :amount_in_cents, 10)
    |> field!(:individual_identification_number, :R, :alphanumeric, 15)
    |> field!(:individual_name, :M, :alphanumeric, 22)
    |> field!(:payment_type_code, :O, :alphanumeric, 2)
