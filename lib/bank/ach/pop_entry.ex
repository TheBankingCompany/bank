defmodule Bank.Ach.PopEntry do
  ...
  def parse!(text, line_number, opts) do
    ...
    |> field!(:check_serial_number, :M, :alphameric, 9)
    |> field!(:terminal_city, :M, :alphameric, 4)
    |> field!(:terminal_state, :M, :alphameric, 2)
    |> field!(:individual_name, :O, :alphameric, 22)
